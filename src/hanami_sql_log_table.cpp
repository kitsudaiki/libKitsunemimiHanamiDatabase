 ...
 */
bool
HanamiSqlLogTable::add(Json::JsonItem &values,
 ...
 */
bool
HanamiSqlLogTable::get(Json::JsonItem &result,
 ...
 */
bool
HanamiSqlLogTable::update(Json::JsonItem &values,
                          std::vector<RequestCondition> conditions,
                          ErrorContainer &error)
{
 ...
 */
bool
HanamiSqlLogTable::getAll(TableItem &result,
                          std::vector<RequestCondition> &conditions,
                          ErrorContainer &error,
                          const bool showHiddenValues)
{
 ...
 */
bool
HanamiSqlLogTable::del(std::vector<RequestCondition> conditions,
                       ErrorContainer &error)
{
